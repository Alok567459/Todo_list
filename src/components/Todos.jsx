              ...
              {editingId === todo.id ? (
                <form onSubmit={saveEdit} className="flex items-center gap-2">
                  <input
                    ...
                    className="bg-gray-800 rounded border border-gray-700 text-gray-100 py-1 px-2"
                  />
                  <button
                    type="submit"
                  ...
                  <button
                    type="button"
                    onClick={cancelEdit}
                    className="text-white bg-gray-600 border-0 py-1 px-3 rounded hover:bg-gray-700"
                  >
                    Cancel
                  </button>
                </form>
